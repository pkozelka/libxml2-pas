...
*}
  ...
  function xmlParseDoc (cur: PChar) : xmlDocPtr; cdecl; external LIBXML2_SO;
  ...
  function xmlSAXParseDoc (sax: xmlSAXHandlerPtr; cur: PChar; recovery: Longint) : xmlDocPtr; cdecl; external LIBXML2_SO;
